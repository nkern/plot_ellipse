'''
Script to plot an ellipse using matplotlib.pyplot in Python 2.7
...
def plot_ellipse(semimaj=1,semimin=1,phi=0,x_cent=0,y_cent=0,theta_num=1e3,ax=None,plot_kwargs=None,\
					fill=False,fill_kwargs=None,data_out=False,cov=None,cov_prob_level=None):
	'''
